...
export const WhyHireMe: React.FC<{ openModal: () => void }> = ({
	openModal,
}) => {
	return (
				...
				<FlexContainer justify={'space-between'}>
					<Styles.PartitionWrapper>
						...
						<Styles.PartitionText>
							...
							placerat at nisl posuere aliquet amet pharetra malesuada.
							Spendisse nisl ac at tortor. Sit faucibus suspendisse risus.
						</Styles.PartitionText>
